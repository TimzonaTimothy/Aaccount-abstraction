	...
	return (
		<>
			...
			<div className="m-6 space-y-4">
				<h1 className="text-white-700 text-5xl font-bold text-center mt-40">
					
					<Link href="/">Smart Contract Wallet</Link>
				</h1>
				{account ? (
					<div className="flex flex-col items-center justify-center">
						...
						<form class="w-6/12" method="post">
							...
							<div className="grid grid-cols-1">
								<button
									class="flex bg-black-500 hover:bg-black-700 text-white font-bold py-2 px-4 rounded justify-center my-5"
									type="button"
									onClick={submitForm}
								>
									{loader ? (
